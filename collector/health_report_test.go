	...
	tests := []struct {
	...
	}{
		{
			...
			want: `
				...
				elasticsearch_health_report_data_stream_lifecycle_status{cluster="docker-cluster",color="green"} 0
				...
				elasticsearch_health_report_max_shards_in_cluster_data{cluster="docker-cluster"} 0
				...
				elasticsearch_health_report_max_shards_in_cluster_frozen{cluster="docker-cluster"} 0
				...
				elasticsearch_health_report_shards_availabilty_status{cluster="docker-cluster",color="green"} 0
				elasticsearch_health_report_shards_availabilty_status{cluster="docker-cluster",color="red"} 0
				elasticsearch_health_report_shards_availabilty_status{cluster="docker-cluster",color="yellow"} 1
				...
				elasticsearch_health_report_shards_capacity_status{cluster="docker-cluster",color="green"} 0
				...
				elasticsearch_health_report_started_primaries{cluster="docker-cluster"} 2
				...
				elasticsearch_health_report_started_replicas{cluster="docker-cluster"} 0
				# HELP elasticsearch_health_report_status Overall cluster status
				# TYPE elasticsearch_health_report_status gauge
				elasticsearch_health_report_status{cluster="docker-cluster",color="green"} 0
				elasticsearch_health_report_status{cluster="docker-cluster",color="red"} 0
				elasticsearch_health_report_status{cluster="docker-cluster",color="yellow"} 1
				# HELP elasticsearch_health_report_total_repositories The number snapshot repositories
				# TYPE elasticsearch_health_report_total_repositories gauge
				elasticsearch_health_report_total_repositories{cluster="docker-cluster"} 0
				...
				elasticsearch_health_report_unassigned_replicas{cluster="docker-cluster"} 1
      `,
		},
	}

...
func TestSLM(t *testing.T) {
	...
	//  docker run -p 9200:9200 -e discovery.type=single-node -e path.repo=/tmp/backups -e 'ES_JAVA_OPTS=-Xms1g -Xmx1g' docker.elastic.co/elasticsearch/elasticsearch:7.17.28

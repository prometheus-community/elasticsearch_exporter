...
| elasticsearch_ingest_total_count                                  | gauge   | 1           | Total number of ingest count since the last JVM restart
| elasticsearch_ingest_total_time_seconds                           | gauge   | 1           | The total ingest time in seconds since the last JVM restart
| elasticsearch_ingest_total_failed                                 | gauge   | 1           | Total number of ingest failed docs since the last JVM restart
| elasticsearch_ingest_total_current                                | gauge   | 1           | Total number of current ingest docs since the last JVM restart

...
| es.aliases.node-labels  |                       | If true, append the `node` label to alias metrics (increases cardinality and issues an extra shard-level stats request when `es.shards` is disabled).                                                                                                                                                                                                                                 | false |

...
| collector.remote-info   |                      | If true, query stats for remote clusters.                                                                                                                                                                                                                                                                                                                                             | false |
...
| collector.data-stream   |                       | If true, query state for Data Streams.                                                                                                                                                                                                                                                                                                                                                 | false |
...
collector.remote-info | `cluster` `monitor` |

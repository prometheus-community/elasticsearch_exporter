...
| collector.ccr          | 1.11.0                 | If true, query Cross-Cluster Replication (CCR) auto-follow, follower, and shard stats.                                                                                                                                                                                                                                                                                                | false |
| collector.ccr.detailed | 1.11.0                 | If true, include high-cardinality CCR per-shard and follower-parameter metrics. When false, only core CCR metrics are exported.                                                                                                                                                                                                                                                       | false |
...
collector.ccr | `cluster` `monitor` | Access `/_ccr/stats` and `/_all/_ccr/info` CCR APIs. |
